...
<script type="text/javascript">
	...
	var latitude = 50.389509,
		longitude = 30.560531,
		map_zoom = 13;

	//google map custom marker icon - .png fallback for IE11
	var is_internetExplorer11= navigator.userAgent.toLowerCase().indexOf('trident') > -1;
	var marker_url = ( is_internetExplorer11 ) ? '<?php echo get_template_directory_uri(); ?>/app/img/mapsgoogle.svg' : '<?php echo get_template_directory_uri(); ?>/app/img/mapsgoogle.svg.png';
		
	//define the basic color of your map, plus a value for saturation and brightness
	var	main_color = '#F69203',
		saturation_value= -40,
		brightness_value= 12;
